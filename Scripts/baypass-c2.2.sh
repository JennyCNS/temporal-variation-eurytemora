...
#SBATCH --job-name=bp-c22
#SBATCH --output=baypass-c22.out
#SBATCH --error=baypass-c22.err
...
-d0yij 20 \
-outprefix $outputdir/c2-model2 -nthreads 10 -contrastfile $inputdir/cov-baypass.txt -seed 100
