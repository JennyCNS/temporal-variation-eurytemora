...
#SBATCH --job-name=bp-c2.4
#SBATCH --output=baypass-c2.4.out
#SBATCH --error=baypass-c2.4.err
...
-d0yij 20 \
-outprefix $outputdir/c2.4-model -nthreads 10 -contrastfile $inputdir/cov-baypass.txt -seed 450
