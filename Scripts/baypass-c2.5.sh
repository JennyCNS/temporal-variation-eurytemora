...
#SBATCH --job-name=bp-c2.5
#SBATCH --output=baypass-c2.5.out
#SBATCH --error=baypass-c2.5.err
...
-d0yij 20 \
-outprefix $outputdir/c2.5-model -nthreads 10 -contrastfile $inputdir/cov-baypass.txt -seed 34
